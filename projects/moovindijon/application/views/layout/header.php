...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>css/jbm.css">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
           ...
           <a href="<?php echo base_url(); ?>index.php/CtrlLogin/disconnect"><i class="fa  fa-power-off fa-3x "></i></a>
          </div>
